...
class ApiService {
  ...
  static Future<List<dynamic>> getScans({Map<String, String>? params}) async {
    ...
    if (res.statusCode != 200) throw Exception('Failed to load scans');
  ...
  static Future<Map<String, dynamic>> submitScan(
    ...
    if (res.statusCode != 201) throw Exception('Failed to submit scan');
    return jsonDecode(res.body);
  }
  ...
  static Future<List<dynamic>> getCheckpoints() async {
    ...
    if (res.statusCode != 200) throw Exception('Failed to load checkpoints');
    return jsonDecode(res.body);
  }
  ...
  static Future<Map<String, dynamic>> clockIn() async {
    ...
    if (res.statusCode != 201) throw Exception('Failed to clock in');
    return jsonDecode(res.body);
  }
  ...
  static Future<Map<String, dynamic>> clockOut() async {
    ...
    if (res.statusCode != 200) throw Exception('Failed to clock out');
    return jsonDecode(res.body);
  }
  ...
  static Future<Map<String, dynamic>> getShiftStatus() async {
    ...
    if (res.statusCode != 200) throw Exception('Failed to get shift status');
    return jsonDecode(res.body);
  }
}
