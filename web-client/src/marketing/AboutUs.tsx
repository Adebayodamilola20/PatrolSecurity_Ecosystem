...
const AboutUs = () => {
    ...
    const stats = [
        { label: 'Founded', value: '2024', icon: Calendar, color: 'text-teal-400' },
        { label: 'Active Users', value: '10k+', icon: Users, color: 'text-cyan-400' },
        { label: 'Uptime', value: '99.99%', icon: Zap, color: 'text-teal-400' },
    ...
    const timeline = [
        ...
        },
        {
            ...
            icon: Cpu,
            glow: 'from-slate-800 to-slate-600',
        },
        {
            year: '2026',
            title: 'Evergreen 1.0',
    ...
    return (
        <div className="min-h-screen bg-white text-slate-900 selection:bg-teal-500/30 selection:text-teal-200 font-sans overflow-x-hidden pt-24 pb-20">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <section className="text-center mb-24 relative">
                    <FadeDown>
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-50 border border-slate-200 text-xs font-medium text-slate-600 mb-8 backdrop-blur-md transform-gpu">
                ...
                <section className="mb-32 text-center">
                    <FadeDown delay={0.2}>
                        <p className="text-sm font-medium text-slate-500 mb-8 uppercase tracking-[0.2em]">Backed by world-class investors</p>
                        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-50 grayscale">
                            <div className="text-xl md:text-2xl font-bold tracking-tighter hover:opacity-100 hover:grayscale-0 transition-all cursor-default text-slate-900">SEQUOIA</div>
                            ...
                            <div className="text-xl md:text-2xl font-bold tracking-tighter hover:opacity-100 hover:grayscale-0 transition-all cursor-default text-slate-900">a16z</div>
                            <div className="text-xl md:text-2xl font-bold tracking-tighter hover:opacity-100 hover:grayscale-0 transition-all cursor-default text-slate-900">LIGHTSPEED</div>
                        </div>
                    </FadeDown>
                </section>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                        {stats.map((stat, idx) => (
                            <FadeDown key={stat.label} delay={idx * 0.1}>
                                <div className="group relative p-6 rounded-2xl bg-slate-50 border border-slate-200 backdrop-blur-md hover:bg-slate-100 transition-all duration-300 transform-gpu">
                                    <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-slate-100 to-transparent pointer-events-none rounded-2xl" />
                ...
                <section className="mb-40">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <FadeDown delay={0.1} className="md:col-span-2">
                            <div className="h-full p-8 rounded-3xl bg-slate-50 border border-slate-200 backdrop-blur-md relative overflow-hidden group transform-gpu">
                                <div className="absolute top-0 right-0 w-64 h-64 bg-teal-500/10 blur-[80px] -mr-20 -mt-20 group-hover:bg-teal-500/20 transition-colors" />
                                <Shield className="w-10 h-10 text-teal-400 mb-6" />
                                <h3 className="text-2xl font-bold mb-4">Privacy First</h3>
                                <p className="text-slate-600 text-lg leading-relaxed max-w-md">
                                    We believe your thoughts should be yours alone. Evergreen is built with end-to-end encryption from the ground up, ensuring that only you can access your data.
                                </p>
                            </div>
                        </FadeDown>
                        ...
                        <FadeDown delay={0.3} className="md:col-span-3">
                            <div className="p-8 rounded-3xl bg-slate-50 border border-slate-200 backdrop-blur-md relative overflow-hidden group flex flex-col md:flex-row md:items-center gap-8 transform-gpu">
                                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-gradient-to-r from-teal-500/5 to-blue-500/5 blur-[100px] pointer-events-none" />
                ...
                <section className="mb-40">
                    ...
                    <div ref={timelineRef} className="relative max-w-4xl mx-auto py-10">
                        ...
                        <motion.div
                            ...
                            className="absolute left-1/2 -translate-x-1/2 top-0 w-[2px] bg-gradient-to-b from-teal-500 via-cyan-500 to-teal-500 shadow-[0_0_15px_rgba(20,184,166,0.5)] origin-top transform-gpu"
                        />
                            ...
                            {timeline.map((item, idx) => (
                                <div key={item.year} className={`flex flex-col ${idx % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} items-center gap-8 md:gap-16 relative z-10`}>
                                    <div className={`flex-1 ${idx % 2 === 0 ? 'md:text-right' : 'md:text-left'} w-full`}>
                                        <FadeDown delay={0.1}>
                                            <div className="relative inline-block mb-2">
                                                ...
                                                <span className="text-5xl font-black text-slate-200 block select-none">
                                                    {item.year}
                                                </span>
                                    ...
                                    <FadeDown className="relative z-10">
                                        <div className="w-12 h-12 rounded-full bg-white border-2 border-slate-300 flex items-center justify-center shadow-[0_0_20px_rgba(15,23,42,0.06)] relative overflow-hidden group">
                                            <div className="absolute inset-0 bg-gradient-to-br from-teal-500/20 to-cyan-500/20 opacity-0 group-hover:opacity-100 transition-opacity" />
                                            <item.icon className="w-5 h-5 text-slate-700 relative z-10" />
                                        </div>
                                    </FadeDown>
                ...
                <section className="mb-40">
                    <FadeDown>
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-4xl font-bold mb-4">The Minds Behind Evergreen</h2>
                            <p className="text-slate-600 max-w-xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {team.map((member, idx) => (
                            <FadeDown key={member.name} delay={idx * 0.1}>
                                <div className="group flex flex-col items-center text-center p-8 rounded-3xl bg-slate-50 border border-slate-200 backdrop-blur-md hover:bg-slate-100 hover:-translate-y-2 transition-all duration-500 transform-gpu">
                                    <div className="relative mb-6">
                                        <div className="absolute inset-0 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full blur-md opacity-0 group-hover:opacity-40 transition-opacity duration-500 transform-gpu" />
                                        <img
                                            src={member.image}
                                            alt={member.name}
                                            referrerPolicy="no-referrer"
                                            className="w-32 h-32 rounded-full border-2 border-slate-200 relative z-10 grayscale group-hover:grayscale-0 transition-all duration-500 object-cover"
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        <a href={member.twitter} className="p-2 rounded-full bg-slate-50 hover:bg-slate-100 text-slate-600 hover:text-slate-900 transition-all transform-gpu">
                                            <MessageCircle className="w-4 h-4" />
                                        </a>
                                        <a href={member.linkedin} className="p-2 rounded-full bg-slate-50 hover:bg-slate-100 text-slate-600 hover:text-slate-900 transition-all transform-gpu">
                                            <Briefcase className="w-4 h-4" />
                                        </a>
                                        <a href="#" className="p-2 rounded-full bg-slate-50 hover:bg-slate-100 text-slate-600 hover:text-slate-900 transition-all transform-gpu">
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center">
                            <FadeDown>
                                <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-slate-900 mb-6">
                                    Join the <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-600 to-teal-600">Mission</span>
                                </h2>
